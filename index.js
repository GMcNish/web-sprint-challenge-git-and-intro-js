...
// console.log("Task 3:", getArtistByIndex(artists,13))
...
function removeArtist(array, index) {
  const removeArtArray = array;
  removeArtArray.splice(index, 1);
  return removeArtArray;
}
